...
def main():
    ...
    joblib.dump(best_model_simple, 'Classification/models/logreg_gd_simple')
    # Evaluate the logistic regression gradient descent model
    ...
    joblib.dump(logreg,'Classification/models/logreg_simple')
    ...
    joblib.dump(dt,'Classification/models/tree_smote')
    ...
    model = joblib.load('Classification/models/logreg_gd_smote')
    # Evaluate the logistic regression gradient descent model
    ...
    """
    model = joblib.load('Classification/models/tree_simple')
